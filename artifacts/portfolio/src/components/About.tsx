...
function CountUpStat({ value, suffix, label, decimals }: { value: number; suffix: string; label: string; decimals: number }) {
  ...
  return (
    <div ref={ref} className="flex flex-col items-center justify-center p-5 rounded-2xl border border-border bg-card">
    ...
    <section id="about" className="py-28 relative bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={fadeUp} className="relative">
            ...
            >
              <div className="w-full h-full rounded-full flex items-center justify-center bg-card">
                <span className="text-4xl font-black text-primary" style={{ fontFamily: "'Inter', sans-serif" }}>KR</span>
              </div>
            </div>
          </motion.div>

          <motion.div variants={fadeUp} className="grid grid-cols-3 gap-4 w-full">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold leading-snug text-foreground">
